            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    data.products.forEach(function (product) {
                        ...
                        var productRatingLabelElement = document.createElement('label');
                        productRatingLabelElement.className = 'rating';
                        productRatingLabelElement.textContent = product.rating.toString();
                        var productRatingInputElement = document.createElement('input');
                        ...
                        mainSection === null || mainSection === void 0 ? void 0 : mainSection.appendChild(productSection);
                    });
                    return [2 /*return*/];
            }
        });
